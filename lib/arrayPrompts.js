...
// see if they want an employee reference
var confirmSeeEmpQ
    = [
        {
            // do you want to see the current list of employees?
            type: 'confirm',
            message: 'Do you want to see the current list of employees for reference?',
            name: 'confirmSeeList',
            default: true
        },
    ];

// see if they want a departments reference
var confirmSeeDepQ
    = [
        {
            // Do want to see the current list of employees?
            type: 'confirm',
            message: 'Do you want to see the current list of departments for reference?',
            name: 'confirmSeeList',
            default: true
        },
    ];

// see if they want a roles reference
var confirmSeeRolesQ
    = [
        {
            // Do want to see the current list of employees?
            type: 'confirm',
            message: 'Do you want to see the current list of roles for reference?',
            name: 'confirmSeeList',
            default: true
        },
    ];
